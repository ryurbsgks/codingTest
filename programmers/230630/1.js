...
function solution(str1, str2) {
  ...
  let newArr = JSON.parse(JSON.stringify(arr2));
  let intersection = arr1.reduce( (acc, cur) => {
  ...
  let union = arr1.length + arr2.length - intersection.length;

  answer = Math.floor((intersection.length / union) * 65536)
